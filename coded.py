...
menu_file.add_command(label="New File", accelerator="Ctrl+N", command=new_file)
menu_file.add_separator()
menu_file.add_command(label="Open File", accelerator="Ctrl+O", command=open_file)
menu_file.add_separator()
menu_file.add_command(label="Save", accelerator="Ctrl+S", command=save)
menu_file.add_command(label="Save As", accelerator="Ctrl+Shift+S", command=save_as)
menu_file.add_separator()
